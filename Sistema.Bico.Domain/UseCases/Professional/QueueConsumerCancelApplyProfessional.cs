...
{
    public class QueueConsumerCancelApplyProfessional : BackgroundService
    {
        ...
        public QueueConsumerCancelApplyProfessional(
             ...
             IServiceScopeFactory serviceScopeFactory)
        {
            ...
            _channel.QueueDeclare(
                    queue: MessageType.CancelApplyProfessional.GetDescription(),
                    durable: false,
                    exclusive: false,
                    autoDelete: false,
                    arguments: null
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                consumer.Received += async (sender, eventArgs) =>
                {
                    ...
                    var message = JsonConvert.DeserializeObject<CancelApplyProfessionalCommand>(contentString);
                    _ = await _mediator.Send(message, stoppingToken);
                };

                _channel.BasicConsume(MessageType.CancelApplyProfessional.GetDescription(), true, consumer);
            }
            catch (Exception e)
            {
