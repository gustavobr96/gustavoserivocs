...
namespace SistemaBico.Web.Util
{
    public class ConvertGeneric
    {
        ...
        //    return destImage;
        //}
        public static decimal CalculaPercent(string valor, int multiplicador)
        {
            var resul = Math.Round((decimal.Parse(valor.Replace(",", ".")) * 100) / multiplicador, 2);
            return resul;
        }
        ...
        public static string ConvertTelefoneLimpo(string telefone)
        {
