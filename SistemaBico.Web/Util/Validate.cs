...
namespace SistemaBico.Web.Util
{
    public static class Validate
    {
        ...
        public static bool ValidarData(string dataIn)
        {
            DateTime dateOut;

            return DateTime.TryParseExact(dataIn, "dd/MM/yyyy",
            CultureInfo.InvariantCulture, DateTimeStyles.None, out dateOut);
        }
